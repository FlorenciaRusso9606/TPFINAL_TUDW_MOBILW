...
export const editProfilSchema = z.object({
    ...
    country_iso: z.string().max(100, "El máximo son 2 caracteres").min(2, "El mínimo son 2 caracteres").optional().transform((v) => v ? v.toUpperCase() : v),
    city: z.string().max(100, "El máximo son 100 caracteres").optional(),
